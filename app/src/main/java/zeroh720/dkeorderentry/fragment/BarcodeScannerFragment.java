...
import com.google.android.gms.samples.vision.barcodereader.ui.camera.BarcodeCallback;
...
import zeroh720.dkeorderentry.activity.BaseActivity;
import zeroh720.dkeorderentry.activity.MainActivity;
import zeroh720.dkeorderentry.activity.OrderActivity;
...
//                });
                ...
                BarcodeScannerFragment.this.getActivity().startActivity(intent);
            }
        });
    ...
    private boolean onTap(float rawX, float rawY) {
        ...
        if (graphic != null) {
            ...
            if (barcode != null) {
                ...
                //TODO: startActivity(getActivityContext(), OrderActivity.class);
